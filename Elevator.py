...
from PyQt5.QtWidgets import QWidget, QHBoxLayout, QGridLayout, QPushButton, QLCDNumber, QLabel, QApplication
...
class ElevatorInterface(QWidget):  # 主窗口
    ...
    def initUI(self):
        ...
        layout.addWidget(gwg)  # 部件加至全局布局

        self.setLayout(layout)  # 窗体本体设置全局布局
        ...
        for i in nameforallup:
            ...
            gridLayoutLeft.addWidget(self.button, 20 - fori, 0)
            fori = fori + 1
        ...
        for i in nameforalldown:
            ...
            gridLayoutLeft.addWidget(self.button, 20 - fori, 1)
            fori = fori + 1
